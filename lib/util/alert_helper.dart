...
class AlertHelper {
  ...
  Future<void> disconnect(BuildContext context) async {
    MyText title = MyText("Voulez-vous vous déconnecter", color: Colors.black,);
    return showDialog(
        context: context,
      barrierDismissible: false, // ne pas pouvoir cliquer autre part
      builder: (BuildContext ctx) {
          return (Theme.of(context).platform == TargetPlatform.iOS) ?
